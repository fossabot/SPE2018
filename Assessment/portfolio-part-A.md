...
Your portfolio should be written in "mark down" text. Each of the following sections should be provided as a separate document. Images should be created as separate files. All materials should be included in a folder called “Portfolio A”.
